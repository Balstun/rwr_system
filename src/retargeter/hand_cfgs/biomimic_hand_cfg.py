...
RETARGETER_OPTIONS = {
    "num_active_keyvectors": 17,
}

BiomimicHandCfg = HandCfg(GC_TENDONS, FINGER_TO_TIP, FINGER_TO_BASE, FINGER_TO_KNUCKLE, GC_LIMITS_LOWER, GC_LIMITS_UPPER, RETARGETER_OPTIONS)
